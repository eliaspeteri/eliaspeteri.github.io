...
const About = () => (
  <StyledAbout data-testid="aboutComponent" className="has-shadow light-bg">
    <>
      <h2>About me</h2>
      <p>
        ICT Engineering student working on Bachelor&apos;s degree in Software
        Engineering. Hails from Lapland but currently living in Tampere area.
      </p>
      <p>
        Looking for a part-time home, and hoping to eventually grow to fulfill a
        full-time position as studies come to a close.
      </p>
      <p>
        <b>
      ...
      <ul className="list-container">
        ...
        <li className="list-item">Jack of all trades, master of some</li>
      </ul>
      <h2>Skills</h2>
      <h3>Frontend</h3>
      React, JS/HTML/CSS.
      <h3>Backend</h3>
      MongoDB, SQL (Postgres), Node.js, axios, express, Jest, REST APIs.
      <h3>Scripting</h3>
      Python, shell.
      <h3>Miscellaneous</h3>
